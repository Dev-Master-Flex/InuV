...
contract DAPE is ERC20, Ownable {
    ...
    constructor(address utility1Addr, address utility2Addr, address utility3Addr, address utility4Addr) ERC20("Dont Ape", "DAPE") {
        ...
        uint256 _buyVaultFee = 10;
        uint256 _sellBurnFee = 0;
        uint256 _sellVaultFee = 10;
        uint256 totalSupply = 200000000 * 10**_decimals;
        supply += totalSupply;
        walletDigit = 1;
        transDigit = 1;
        delayDigit = 0;
